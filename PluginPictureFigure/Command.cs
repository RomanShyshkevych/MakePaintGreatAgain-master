using PluginPictureFigure.Controls;
using System;
...
namespace PluginPictureFigure
{
    public class Command
    {
        ...
        ToolStripSplitButton fillPicture;
        PProperty pr;
        bool isExist = false;
        ...
        public void ChangePictureFillings(String font)
        {
        ...
        public void AddMenu(ToolStrip stripMenu, GroupBox property)
        {
            ...
            fillPicture = new ToolStripSplitButton("Picture figure");
            fillPicture.DropDownItems.Add(new ToolStripMenuItem("Filling", null, delegate { ChangePictureFillings("Filling"); }));
            fillPicture.DropDownItems.Add(new ToolStripMenuItem("Stretching", null, delegate { ChangePictureFillings("Stretching"); }));
            fillPicture.DropDownItems.Add(new ToolStripMenuItem("Center", null, delegate { ChangePictureFillings("Center"); }));
            ...
            stripMenu.Items.Add(fillPicture);
        ...
        public void DelMenu(ToolStrip stripMenu, GroupBox property)
        {
            ...
            stripMenu.Items.Remove(fillPicture);
